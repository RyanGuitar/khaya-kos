...
import { sync } from "./sync.js?v=3.21";
import { renderAll, renderCategory, patchCard, patchLikeCount, patchStock, renderMarketSection } from "./renderer.js?v=3.21";
import { createImageCropper } from "./imageCropper.js?v=3.21";
